...
>>>>>>> eb1135ee4a07fd342e1023aca32a11f45ac43674
</head>
            ...
            <li class="nav-item">
                ...
                <div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"  href="javascript:void(0)" url="<?php echo base_url('admin/user'); ?>">Users</a>
                        <h6 class="collapse-header">Roles</h6>
                        <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('admin/role'); ?>">Roles</a>
                        <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('admin/user_role'); ?>">User Role</a>
                    </div>
                </div>
            </li>
