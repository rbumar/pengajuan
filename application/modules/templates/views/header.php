    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pengajuan <sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"  href="javascript:void(0)" url="<?php echo base_url('user'); ?>">Users</a>
                        <h6 class="collapse-header">Roles</h6>
                        <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('role'); ?>">Roles</a>
                        <!-- <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('role/user_role'); ?>">User Role</a> -->
                    </div>
                </div>
            </li>
            ...
            <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('karyawan'); ?>">Karyawan</a>
        ...
        <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="javascript:void(0)" url="<?php echo base_url('pettycash'); ?>">Petty Cash</a>
